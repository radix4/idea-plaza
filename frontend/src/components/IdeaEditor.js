...
import { Card, Row, Col, Container, Button, Form, Table, InputGroup } from 'react-bootstrap'
          ...
          <Card>
            <Form id='edit' onSubmit={submitChanges}>
              <Form.Group
                ...
                <Card.Header as='h2'>
                  <InputGroup>
                    <Form.Control id='idea-title' name='title' type='text' placeholder='Idea Title' defaultValue={ideaInfo.title} />
                    <Button type='submit' size='sm' style={styles.buttonRight}>Save changes</Button>
                  </InputGroup>
                </Card.Header>
                <Card.Body>
                  <Card.Text>
                    <b>Domain</b>:
                    <Form.Control name='domain' type='text' placeholder='Content...' defaultValue={ideaInfo.problemStatement.domain} />
                  </Card.Text>
                  <Card.Text>
                    <b>State of the art</b>:
                    <Form.Control name='stateOfTheArt' type='text' placeholder='Content...' defaultValue={ideaInfo.problemStatement.stateOfTheArt} />
                  </Card.Text>
                  <Card.Text>
                    <b>Solution</b>:
                    <Form.Control name='solution' type='text' placeholder='Content...' defaultValue={ideaInfo.problemStatement.solution} />
                  </Card.Text>
                </Card.Body>
